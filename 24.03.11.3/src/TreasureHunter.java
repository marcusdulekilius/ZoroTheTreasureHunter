...
public class TreasureHunter extends JPanel {
    ...
    public TreasureHunter() {
        ...
        newMapButton.setPreferredSize(new Dimension(140, 70));
        newMapButton.setBackground(new Color(52, 130, 169));
        newMapButton.setForeground(new Color(208,169,51));
        newMapButton.setFont(newMapButton.getFont().deriveFont(Font.BOLD | Font.ITALIC,20));
        
        startButton.setPreferredSize(new Dimension(140, 70));
        startButton.setBackground(new Color(52, 130, 169));
        startButton.setForeground(new Color(208,169,51));
        startButton.setFont(startButton.getFont().deriveFont(Font.BOLD | Font.ITALIC,30));

        add(newMapButton, new GridBagConstraints());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Zoro the Treasure Hunter");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.setSize(720, 720);
            frame.setResizable(false);
            frame.setLocationRelativeTo(null);
            frame.add(new TreasureHunter());
